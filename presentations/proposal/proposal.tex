...
Yahaya Ali \\
\vspace{0.2cm}
\textit{Academic Adviser: Associate Prof. Dimitry Rudenko}
}
...
\usebackgroundtemplate{%
    \begin{tikzpicture}[remember picture,overlay] 
        \fill[chartreuse, opacity=0.2] (current page.north west) rectangle (current page.south east); 
        \node[opacity=0.2] at (current page.center) {\includegraphics[width=\paperwidth,height=\paperheight]{dag.png}};
    \end{tikzpicture}}
%------------------------------------------------
\begin{frame}
\titlepage
...
\usebackgroundtemplate{%
    \begin{tikzpicture}[remember picture,overlay] 
        \fill[chartreuse, opacity=0.2] (current page.north west) rectangle (current page.south east); 
        \node[opacity=0.3] at (current page.center) {\includegraphics[width=\paperwidth,height=\paperheight]{}};
    \end{tikzpicture}} 
